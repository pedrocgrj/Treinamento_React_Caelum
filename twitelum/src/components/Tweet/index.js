...
class Tweet extends Component {
    ...
    likeHandler = () => {
        ...
        fetch(`https://twitelum-api-alessandro.herokuapp.com/tweets/${idDoTweet}/like?X-AUTH-TOKEN=${localStorage
            .getItem('TOKEN')}`, { method: 'POST' })
            ...
            <article className="tweet">
                ...
                <footer className="tweet__footer">
                    <button className="btnLike	btn	btn--clean" onClick={this.likeHandler}>
                        <svg className={`icon	icon--small	iconHeart	${this.state.likeado ? 'iconHeart--active' : ''}`}
